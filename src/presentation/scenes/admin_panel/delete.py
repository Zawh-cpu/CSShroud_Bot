...
class DeleteScene(scene.Scene, state="admin_panel-delete"):
    ...
    async def default_handler(self, query: types.CallbackQuery or types.Message,
        ...
        text = translator.translate("admin_panel-manage_user-delete-text").format(id=translator.key_short_id(selected_user))
        ...
        keyboard = [
            ...
            [
                types.InlineKeyboardButton(text=translator.translate("ui-tag-confirm-short"), callback_data=tools.Selector(i=selected_user).pack()),
